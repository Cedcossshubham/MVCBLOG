      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-transparent sidebar collapse">
        <div class="position-sticky pt-3 my-5">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link active text-dark" aria-current="page" href="dashboard">
              ...
              <?php
                ...
                foreach ($data[0] as $value) {
                    ...
                    if ($role=='user') {
                        ...
                        <div class="card-body">
                        <img class="card-img-top" src="'.URLROOT . 'assets/img/blog.jpg'.'" alt="Card image cap">
                            <h5 class="card-title fw-bold">'.$value->blogtitle.'</h5>
                            <p class="card-text">'.$value->content.'</p>
                            <p class="text-dark"><span class="fw-bold">Visibility: </span>'.$value->status.'</p>
                            <a type="submit" href="deleteblog?id='.$value->blog_id.'" class="btn btn-primary bg-danger">Delete</a>
                            <a type="submit" href="editblog?id='.$value->blog_id.'&action=Edit_Post" class="btn btn-primary ">edit</a>
                        </div>
                        </a>
                        </div>';
                    } elseif ($role=='admin') {
